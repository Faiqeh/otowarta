...
<head>
	...
	<?php foreach($select_news as $data): ?>
		<title>Otowarta | <?=$data['news_tittle'];?></title>
	<?php endforeach ?>
					...
					<div class="col-lg-9 main-wrapper-content">
						...
						<main class="site-main style-one">
							<div class="row gutters-50">
								<div class="col-lg-12">
									<?php foreach($select_news as $data): ?>
										<article class="post hentry style-one text-center shadow">
											<div class="entry-thumb">
												<figure class="thumb-wrap">
													<img src="assets/images/news/<?=$data['news_img'];?>" alt="post" />
												</figure>
											</div>
