...
<body class="bg-white-smoke">
	...
	<div class="site-content">
								...
								<div class="header-right-area">
									<div class="search-wrap">
										...
										<div class="search-form">
											<form action="#">
												<input type="search" placeholder="Telusuri" name="search">
		...
		<!-- CAROUSEL -->
		<div class="frontpage-slider-posts mrb-30 mt-4">
									...
									<div class="entry-thumb">
										<figure class="thumb-wrap">
											<a href="news.php?news_id=<?=$data['news_id'];?>">
												<img src="assets/images/news/<?=$data['news_img'];?>" style="width:1288px; height:634px" />
											</a>
										</figure>
									</div>
